...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = "gearmanserver"
  ...
  config.vm.provision "file", source: "workermanager.conf", destination: "/tmp/workermanager.conf"
  config.vm.provision "file", source: "25-gearman.ini", destination: "/tmp/25-gearman.ini"
